...
public class CheckAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            RemoteViews views = new RemoteViews(context.getPackageName(), com.demo.jachen.checkwidget.library.R.layout.check_widget);
            views.setOnClickPendingIntent(com.demo.jachen.checkwidget.library.R.id.button, pendingIntent);

            views.setTextViewText(com.demo.jachen.checkwidget.library.R.id.button, String.format("Update:%s", TimeUtil.getTime()));
