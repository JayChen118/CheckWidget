...
public class MyIntentService extends IntentService {
    ...
    private static final String ACTION_BAZ = "com.demo.jachen.checkwidget.action.BAZ";

    // TODO: Rename parameters
    private static final String EXTRA_PARAM1 = "com.demo.jachen.checkwidget.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "com.demo.jachen.checkwidget.extra.PARAM2";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String temp = SharedPreferencesUtil.readRecord(this);
        temp = String.format("Alarm:%s", TimeUtil.getTime()) + "\n" + temp;
        if (temp.length() > 1000) {

            temp = temp.substring(0, 1000);
        }
        SharedPreferencesUtil.storeRecord(this, temp);
